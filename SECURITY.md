...
This repository is an independent AI context resource pack for milvus-io/milvus. It is not Milvus's official security contact.
...
Upstream product vulnerabilities should be reported to milvus-io/milvus's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
