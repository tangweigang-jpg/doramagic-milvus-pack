...
Use this pack to help an AI coding agent work with `milvus-io/milvus` safely and verifiably.

## When To Use

- The user wants `load Milvus vector database context, collection lifecycle boundaries, query checks, and RAG storage verification notes into your AI host before indexing real data`.
